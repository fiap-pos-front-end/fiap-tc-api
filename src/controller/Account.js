const DetailedAccountDTO = require('../models/DetailedAccount');
const TransactionDTO = require('../models/Transaction');
...
class AccountController {
  ...
  async createTransaction(req, res) {
    ...
    const transactionDTO = new DetailedAccountDTO({ accountId, value, from, to, anexo, type, date: new Date() });
  ...
  async createNewTransaction(req, res) {
    ...
    const transactionDTO = new TransactionDTO({ type, amount, date, category });
    console.log('## CL ## params', transactionDTO);
